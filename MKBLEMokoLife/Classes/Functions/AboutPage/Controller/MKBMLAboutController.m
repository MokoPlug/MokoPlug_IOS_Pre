...
@implementation MKBMLAboutController

- (void)dealloc {
    NSLog(@"MKBMLAboutController销毁");
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKBMLAboutDataModel *model = self.dataList[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKBMLAboutCell *cell = [MKBMLAboutCell initCellWithTableView:tableView];
...
- (void)loadTableDatas {
    MKBMLAboutDataModel *faxModel = [[MKBMLAboutDataModel alloc] init];
    faxModel.iconName = @"mk_bml_about_faxIcon";
    faxModel.typeMessage = @"Fax";
    faxModel.value = @"86-75523573370-808";
    [self.dataList addObject:faxModel];
    
    MKBMLAboutDataModel *telModel = [[MKBMLAboutDataModel alloc] init];
    telModel.iconName = @"mk_bml_about_telIcon";
    telModel.typeMessage = @"Tel";
    telModel.value = @"86-75523573370";
    [self.dataList addObject:telModel];
    
    MKBMLAboutDataModel *addModel = [[MKBMLAboutDataModel alloc] init];
    addModel.iconName = @"mk_bml_about_addIcon";
