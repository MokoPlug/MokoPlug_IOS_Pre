...
@interface MKBMLUpdateFileController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKBMLUpdateFileController

- (void)dealloc {
    NSLog(@"MKBMLUpdateFileController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(mk_bml_selectedFileName:)]) {
        [self.delegate mk_bml_selectedFileName:firmwareModel.leftMsg];
    }
