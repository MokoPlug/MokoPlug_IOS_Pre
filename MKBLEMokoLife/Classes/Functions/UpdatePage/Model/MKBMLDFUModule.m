...
@interface MKBMLDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKBMLDFUModule

- (void)dealloc{
    NSLog(@"MKBMLDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKBMLCentralManager shared].peripheral];
}
